 ...
 */
final class Version20251208201936 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ACTIVIDAD_ODS ADD CONSTRAINT FK_E22C2136EAF33370 FOREIGN KEY (id_ods) REFERENCES ods (id)');
        ...
        $this->addSql('ALTER TABLE ACTIVIDAD_TIPO ADD CONSTRAINT FK_5FD41A3AFB0D0145 FOREIGN KEY (id_tipo) REFERENCES tipo_voluntariado (id)');
