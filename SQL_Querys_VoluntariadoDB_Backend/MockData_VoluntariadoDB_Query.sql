...
-- =========================================================================
-- CARGA DE DATOS MAESTROS (Cat�logos)
-- =========================================================================
...
-- -------------------------------------------------------------------------
-- USUARIO 1: ORGANIZACI�N "EcoPlanet"
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- USUARIO 4: VOLUNTARIO "Laura Garc�a"
-- -------------------------------------------------------------------------
INSERT INTO USUARIO (correo, google_id, id_rol, estado_cuenta) 
...
INSERT INTO ACTIVIDAD (id_organizacion, titulo, descripcion, fecha_inicio, duracion_horas, cupo_maximo, ubicacion, estado_publicacion)
VALUES (@idOrgEco, 'Taller de Reciclaje Creativo', 'Aprende a reutilizar materiales.', DATEADD(day, 14, GETDATE()), 2, 10, 'Centro C�vico', 'En revision');

-- ACTIVIDAD 3: Reforestaci�n (Borrada / Soft Delete)
